...
## Getting Started
Install the platformIO in VSCode and add this project, next upload first on esp32 (connect directly download pin to gnd), next to resenans microchip, use andother serial monitor than built in platformio.
