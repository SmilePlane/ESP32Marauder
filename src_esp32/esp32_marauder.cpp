...
{    esp_uno_r4_setup();
  ...
  SERIAL_AT.println("ESP-IDF version is: " + String(esp_get_idf_version()));
SERIAL_AT.println("WORK!!!");
  #ifdef HAS_SCREEN
  ...
  */
  ...
  backlightOn(); // Need this
    ...
    // Do some stealth mode stuff
      ...
      if (c_btn.justPressed()) {
        ...
        SERIAL_AT.println("Headless Mode enabled");
      }
    #endif
  ...
  buffer_obj = Buffer();
    ...
    if(sd_obj.initSD()) {
      ...
      SERIAL_AT.println(F("SD Card NOT Supported"));
      #ifdef HAS_SCREEN
